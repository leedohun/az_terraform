...
1. From a browser, go to [Download Latest Terraform Release](https://www.terraform.io/downloads.html).

2. Find the link for your environment and then **copy** the link address. Example for Linux 64-bit:
   ```script
...
1. Creates an execution plan. By default, creating a plan consists of:
   ```script
...
2. Executes the actions proposed in a Terraform plan.
   ```script
